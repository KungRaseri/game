...
public class CustomerEmotionalResponseTests
{
    ...
    public void CustomerEmotionalResponse_ToString_ReturnsCorrectString(CustomerEmotionalResponse response, string expectedString)
    {
        // Act
    ...
    public void CustomerEmotionalResponse_IsNegative_ReturnsCorrectValue(CustomerEmotionalResponse response, bool expectedIsNegative)
    {
        // Act
        var isNegative = response == CustomerEmotionalResponse.Upset || response == CustomerEmotionalResponse.Frustrated;
    ...
    [InlineData(CustomerEmotionalResponse.Conflicted, false)]
    public void CustomerEmotionalResponse_IsPositive_ReturnsCorrectValue(CustomerEmotionalResponse response, bool expectedIsPositive)
    {
        // Act
        var isPositive = response == CustomerEmotionalResponse.Satisfied || response == CustomerEmotionalResponse.Delighted;
