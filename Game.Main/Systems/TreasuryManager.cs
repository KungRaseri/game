...
public class TreasuryManager
{
    ...
    public bool ProcessExpense(ExpenseType type, decimal amount, string description, bool isRecurring = false, int recurrenceDays = 0)
    {
        ...
        {
            GameLogger.Warning($"Insufficient funds for expense: {description} ({amount} gold needed, {_currentGold} available)");
    ...
    public bool MakeInvestment(string investmentId)
    {
        ...
        {
            GameLogger.Warning($"Cannot afford investment: {investment.Name} ({investment.Cost} gold needed, {_currentGold} available)");
        ...
        GameLogger.Info($"Investment completed: {investment.Name} for {investment.Cost} gold. Expected return: {investment.ExpectedReturn} gold");
    ...
    public FinancialSummary GetFinancialSummary()
    {
        ...
        var summary = new FinancialSummary
        {
            ...
            FinancialAlerts = GetFinancialAlertsInternal(_currentGold, dailyExpenses), // Use internal method to avoid recursion
