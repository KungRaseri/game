...
public class MarketAnalysisTests
{
    ...
    {
        // Arrange
        var qualityTiers = new[]
            { QualityTier.Common, QualityTier.Uncommon, QualityTier.Rare, QualityTier.Epic, QualityTier.Legendary };
    ...
    public void MarketAnalysis_RecommendedStrategy_CanBeDetailed()
    {
        ...
        var analysis = new MarketAnalysis
        {
            ...
            RecommendedStrategy =
                "Maintain current stock levels. Consider small price increase of 5-10%. Monitor competitor pricing weekly.",
