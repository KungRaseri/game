...
/// <summary>
/// Tests for CraftingServiceCollectionExtensions dependency injection configuration.
/// </summary>
public class CraftingServiceCollectionExtensionsTests
{
    private readonly TestableLoggerBackend _testLogger;

    public CraftingServiceCollectionExtensionsTests()
    {
    ...
    public void AddCraftingServices_ReturnsServiceCollection_AllowsMethodChaining()
    {
        ...
        var result = CraftingExtensions.AddCraftingServices(services)
    ...
    public void AddCraftingCoreSystems_ReturnsServiceCollection_AllowsMethodChaining()
    {
        ...
        // Act & Assert - Should allow method chaining
        var result = CraftingExtensions.AddCraftingCoreSystems(services)
            .AddSingleton<string>("test");
